...
public class Splashscreen extends android.support.v7.app.AppCompatActivity {
	...
	private android.widget.TextView persentase;
	private int Value = 0;

	@Override
	protected void onCreate(android.os.Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(net.dika.unis7d.R.layout.activity_splashscreen);
		progressBar = findViewById(net.dika.unis7d.R.id.progress);
		persentase = findViewById(net.dika.unis7d.R.id.persentase);
		...
		final android.os.Handler handler = new android.os.Handler(){
			...
			public void handleMessage(android.os.Message msg) {
				...
				if(Value == progressBar.getMax()){
					android.widget.Toast.makeText(getApplicationContext(), "Selamat Datang", android.widget.Toast.LENGTH_SHORT).show();
					startActivity(new android.content.Intent(net.dika.unis7d.Splashscreen.this, net.dika.unis7d.pancasila.MainActivity.class));
					finish();
				}
				Value++;
			}
